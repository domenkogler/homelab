...
> **Decision log format** (`security.md §7`, `<domain>-rejected.md`): a dated bullet per decision: `- **Decision statement** — accepted/expected, Date: YYYY-MM-DD, *(evidence: KOPS-xx)*`. Historical changelog decisions live in the frozen `reports/changelog.md`.
