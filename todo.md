...
| HD-40A | 3 | AI + Human | 3 | *(Phase 1.5)* **Provision VPS + establish public Traefik edge** — netcup **RS 2000 G12** purchased (263,52 €/12 mo, 2026-08-18) ≈ formerly “Contabo”; ⏳ awaits netcup account confirmation/VPS access, then WireGuard S2S home↔VPS, Traefik on VPS terminates TLS for public subset. Backends still on oldsrv over WG tunnel. Cloudflare A records updated. · [services-vps.md](docs/services-vps.md) |
