...
| HD-135 | VPS/oldsrv split — IaC matrices applied (`b070f7d`); remaining live: WG S2S tunnel + cross-host wiring + live-verify `foto`/`file`/`git`/`ai` round-trip | [services-vps.md](docs/services-vps.md), [storage-zfs.md](docs/storage-zfs.md) |
