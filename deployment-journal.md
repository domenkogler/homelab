...
### 2026-08-23/24 - Phase 1 - session: HD-227 wave-2 corrective batch (pairdrop PUBLIC + forgejo native OIDC + blueprint one-shot apply + onlyoffice unblock + db-backup first dumps + nftables ExecStop override + renovate disable)
