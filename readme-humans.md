# Kogler Homelab (human guide)

> 🔗 **AI / coding agents:** this is the *human/family* README — the original one renamed. If you are
> starting a coding task, read **[`README.md`](README.md)** instead (the AI bootstrap) and follow its
