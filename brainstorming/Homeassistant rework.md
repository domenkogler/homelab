To je odlična in zelo stabilna kombinacija. **Grafana** bo poskrbela za čudovito vizualizacijo analitičnih podatkov (vreme, rekuperator, Mikrotik), **TileBoard** pa bo služil kot hiter in odziven nadzorni center za upravljanje (luči, žaluzije, Shelly RGBW, Shield).

Spodaj najdete pripravljen **glavni sistemski prompt**, ki ga lahko skupaj s svojim seznamom entitet posredujete umetni inteligenci (AI), ter **predloge za izboljšavo in prilagoditev**, da boste dobili najboljši možen rezultat.

## ---

**📝 Glavni Prompt za AI (Kopirajte to besedilo)**
