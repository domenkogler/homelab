...
- **Per-device DNS visibility + control-plane records (HD-334, Option A edge model — SPEC):** two changes, tracked as HD-334 (heading the internal-edge package F in todo.md §2.1a):
