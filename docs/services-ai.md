...
- **Generation → spark (HD-382, 2026-09-17):** `spark/qwen3.8-flash-next` is a runtime DB entry in BOTH
  ...
  `ollama/*,openrouter/*` (granting `spark/*` to the dev harnesses is an open owner call — **HD-384**), and
  the LAN instance's key-minting glue is red on a stale secret (**HD-383**). Until then the gateway path
