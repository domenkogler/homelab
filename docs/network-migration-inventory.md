...
| AP-garaza (wAP ac) | 6C:3B:6B:7D:B9:C5 | 99 (Mgmt) | serves WLAN | confirm exact variant RBwAPG-5Hac**D** vs **T**2HnD (label): T = permanently incompatible with wifi-qcom-ac (MIPSBE); matters only for a future flavor refresh |
| AP-spalnica (hAP ac²) | C4:AD:34:42:F1:7D | 99 (Mgmt) | serves WLAN | wifi-qcom-ac-capable HW (irrelevant while fleet is legacy-CAPsMAN, HD-229) |
| spare hAP ac² ("MikroTik") | C4:AD:34:42:F0:B9 | → becomes AP-dnevna | serves WLAN | consumed by the planned dnevna swap |
