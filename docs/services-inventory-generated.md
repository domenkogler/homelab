...
| 15 | pi-dev | pi-dev | `https://pi-dev.kogler.si` | enabled |
| 16 | dsh | dsh | `https://dsh.kogler.si` | enabled |
...
| 25 | traefik-tailnet | traefik-tailnet | `https://traefik-tailnet.kogler.si` | enabled |
| 26 | n8n | n8n | `https://n8n.kogler.si` | enabled |
| 27 | kopia-server | kopia-server | `https://kopia-server.kogler.si` | enabled |
| 28 | db-backup | db-backup | `https://db-backup.kogler.si` | enabled |
| 29 | matrix | matrix | `https://matrix.kogler.si` | enabled |
| 30 | chat | chat | `https://chat.kogler.si` | enabled |
| 31 | headscale | vpn | `https://vpn.kogler.si` | enabled |
| 32 | metabase | sec | `https://sec.kogler.si` | enabled |
| 33 | crowdsec-web-ui | csui | `https://csui.kogler.si` | enabled |
| 34 | pairdrop | drop | `https://drop.kogler.si` | enabled |
| 35 | stirling-pdf | pdf | `https://pdf.kogler.si` | enabled |
| 36 | renovate | renovate | `https://renovate.kogler.si` | enabled |
