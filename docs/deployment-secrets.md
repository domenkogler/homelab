...
| `wifi-kogler-iot-wan_password` | `password` | ~~CAPsMAN SSID **Kogler IOT WAN** (VLAN 21 IoT-Internet)~~ — **SSID DELETED 2026-09-03 (HD-312):** IOT-WAN collapsed into Kogler IOT; cloud-IoT (Bosch/LG) WAN via `iot-wan-allow` MAC list (phase 3). Item kept in 1Password (no longer referenced by any config). |
