...
| `tube-archivist_login` | `credential` | Tube Archivist (HD-362) **web-UI login** (username in `username`; the archive UI's password) — separate from `tube-archivist_api` (used by the Jellyfin plugin) and `tube-archivist_ui` |
