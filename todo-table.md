...
| **HD-437** ⏳ | **The router advertises both LAN resolvers** (Pi + oldsrv) — decided option (i), no DNS VIP, no manual repoint. Today a Pi outage ends all home resolution, VIP access included, which makes the takeover half-useless. Acceptance is a Pi-powered-off client still resolving, not a config diff. · [todo.md HD-437](todo.md) |
