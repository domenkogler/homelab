...
| HD-335 / HD-337 | 2 | spark (ThinkStation PGX / GB10) bring-up | Owner **physical**: DGX OS install → then AI role/placement/Triton/Mem0 — **also gates the LiteLLM completion round-trip** (HD-100/247 Table-A live-verify currently rides openrouter cloud) |
