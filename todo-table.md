...
| HD-242 | — | Metabase SELECT-only feeds | **SUPERSEDED/MOOT 2026-09-14** — Metabase **retired from the VPS** (sources removed from template; `db_ro` keys commented out in `vps.yml`; vault item left as-is). No owner action |
