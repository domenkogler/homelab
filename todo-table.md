...
| HD-375 | 2 | spark host-memory OOM alert rules (`spark-host-mem-oom-warning/critical`) — author + VPS monitoring converge | Rule design + thresholds are already written up in observability.md §Alerting; authoring + converge + evaluate-verify is AI |
